...
// 修改网站配置
export const editWebConfigDataAPI = (name: WebConfigType, data: object) => Request<Config>('PATCH', `/config/web`, { [name]: data });
...
// 更新页面配置
export const updatePageConfigDataAPI = (pageName: string, config: object) => Request('PATCH', `/config/page`, { pageName, config });
